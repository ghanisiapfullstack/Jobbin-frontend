...
export default function GoogleButton() {
  ...
  return (
    <button
      ...
      onClick={() => login()}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 border-3 border-dark bg-white hover:bg-gray-50 px-4 py-3 font-bold text-dark shadow-neo-sm hover:shadow-neo transition-all disabled:opacity-60"
    >
      {loading ? (
